    ...
    BOOST_AUTO_TEST_SUITE(test_chebyshev_u_compiles)
    
    using namespace rdiff;
    
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_chebyshev_u, T, multiprecision_float_types)
    {
        ...
        rvar<T, 1> x_ad = x;
        auto y = boost::math::chebyshev_u(2,x_ad);
        auto y_expect = boost::math::chebyshev_u(2,x);

    ...
    BOOST_AUTO_TEST_SUITE(test_chebyshev_t_prime_compiles)
    
    using namespace rdiff;
    
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_chebyshev_t_prime, T, multiprecision_float_types)
    {
        ...
        rvar<T, 1> x_ad = x;
        auto y = boost::math::chebyshev_t_prime(3,x_ad);
        auto y_expect = boost::math::chebyshev_t_prime(3,x);

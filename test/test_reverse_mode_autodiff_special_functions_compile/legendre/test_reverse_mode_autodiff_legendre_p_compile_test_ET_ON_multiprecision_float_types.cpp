    ...
    BOOST_AUTO_TEST_SUITE(test_legendre_p_compiles)
    
    using namespace rdiff;
    
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_legendre_p, T, multiprecision_float_types)
    {
        ...
        rvar<T, 1> x_ad = x;
        auto y = boost::math::legendre_p(2,x_ad);
        auto y_expect = boost::math::legendre_p(2,x);

    ...
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_hypergeometric_2F0, T, multiprecision_float_types)
    {
        ...
        rvar<T, 1> x_ad = x;
        auto y = boost::math::hypergeometric_2F0(-1,1,x_ad);
        auto y_expect = boost::math::hypergeometric_2F0(-1,1,x);

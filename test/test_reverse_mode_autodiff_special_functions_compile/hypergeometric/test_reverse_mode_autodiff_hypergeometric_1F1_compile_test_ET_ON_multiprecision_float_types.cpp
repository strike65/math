    ...
    BOOST_AUTO_TEST_SUITE(test_hypergeometric_1F1_compiles)
    
    using namespace rdiff;
    
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_hypergeometric_1F1, T, multiprecision_float_types)
    {
        ...
        rvar<T, 1> x_ad = x;
        auto y = boost::math::hypergeometric_1F1(x_ad,x_ad,x_ad);
        auto y_expect = boost::math::hypergeometric_1F1(x,x,x);

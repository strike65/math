    ...
    BOOST_AUTO_TEST_SUITE(test_gegenbauer_prime_compiles)
    
    using namespace rdiff;
    
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_gegenbauer_prime, T, multiprecision_float_types)
    {
        ...
        rvar<T, 1> x_ad = x;
        auto y = boost::math::gegenbauer_prime(3,1,x_ad);
        auto y_expect = boost::math::gegenbauer_prime(3,1,x);

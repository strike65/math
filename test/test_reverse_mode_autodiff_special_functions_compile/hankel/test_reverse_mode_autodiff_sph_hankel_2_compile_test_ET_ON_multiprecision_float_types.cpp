    ...
    BOOST_AUTO_TEST_SUITE(test_sph_hankel_2_compiles)
    
    using namespace rdiff;
    
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_sph_hankel_2, T, multiprecision_float_types)
    {
        ...
        rvar<T, 1> x_ad = x;
        auto y = boost::math::sph_hankel_2(x_ad,x_ad);
        auto y_expect = boost::math::sph_hankel_2(x,x);

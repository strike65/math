    ...
    BOOST_AUTO_TEST_SUITE(test_cyl_hankel_1_compiles)
    
    using namespace rdiff;
    
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_cyl_hankel_1, T, multiprecision_float_types)
    {
        ...
        rvar<T, 1> x_ad = x;
        auto y = boost::math::cyl_hankel_1(x_ad,x_ad);
        auto y_expect = boost::math::cyl_hankel_1(x,x);

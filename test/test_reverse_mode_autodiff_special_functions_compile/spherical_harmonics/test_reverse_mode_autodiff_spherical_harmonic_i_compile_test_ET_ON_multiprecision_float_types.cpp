    ...
    BOOST_AUTO_TEST_SUITE(test_spherical_harmonic_i_compiles)
    
    using namespace rdiff;
    
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_spherical_harmonic_i, T, multiprecision_float_types)
    {
        ...
        rvar<T, 1> x_ad = x;
        auto y = boost::math::spherical_harmonic_i(2,5,x_ad,x_ad);
        auto y_expect = boost::math::spherical_harmonic_i(2,5,x,x);
